...
const mockState={questions:[],answers:{},status:{},visited:{},secondsLeft:7200,timer:null,started:false,current:0,config:{category:'All',minutes:120}};
...
window.startBankingMock=()=>{
 ...
 mockState.questions=seededShuffle(pool,Date.now()).slice(0,100);mockState.answers={};mockState.status={};mockState.visited={0:true};mockState.secondsLeft=mins*60;mockState.started=true;mockState.current=0;mockState.config={category:cat,minutes:mins};
